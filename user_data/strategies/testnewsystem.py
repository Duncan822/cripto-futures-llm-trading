...
"""
TestNewSystem - Strategia generata automaticamente
"""
...
class Testnewsystem(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[dataframe['rsi'] < 30 & dataframe['ema_short'] > dataframe['ema_long'], 'enter_long'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[dataframe['rsi'] > 70 | dataframe['ema_short'] < dataframe['ema_long'], 'exit_long'] = 1
        return dataframe
